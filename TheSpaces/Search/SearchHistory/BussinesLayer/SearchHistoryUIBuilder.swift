...
//        let tableViewContentInset = UIEdgeInsets(top: topInset, left: 0, bottom: 0, right: 0)
        
//        owner.tableView.contentInset = tableViewContentInset
//        owner.tableView.scrollIndicatorInsets = tableViewContentInset
